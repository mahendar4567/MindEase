  ...
  categories.forEach((cat) => {
    for (let i = 1; i <= cat.count; i++) {
      testCases.push({
        ...
        Preconditions: 'Web App running on http://localhost:5173 / http://10.192.254.186:5173',
...
/**
 * 2. Mobile Appium 300 Test Cases
 */
...
/**
 * 3. API & Security Audit 50 Test Cases
 */
...
/**
 * Main Master Excel File Generator
 */
function generateMasterExcelReport() {
  ...
  // 1. Master Executive Summary Sheet
  ...
  console.log(`• Total Web Test Cases     : ${webCases.length}`);
  console.log(`• Total Mobile Test Cases  : ${mobileCases.length}`);
  console.log(`• Total API Audit Cases    : ${apiCases.length}`);
  console.log(`• Total Load Test Requests : 76,335 (5,089.9 RPS)\n`);
  console.log('===========================================================');
  console.log(' ALL TEST CASES CONSOLIDATED INTO ONE MASTER EXCEL FILE 100%');
  console.log('===========================================================');
}
